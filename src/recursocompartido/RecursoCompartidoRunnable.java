...
public class RecursoCompartidoRunnable {
    ...
    public static void main(String[] args) {
        ...
        procesos.add(new Thread(new ProcesoRunnable(recurso, 1)));
        procesos.add(new Thread(new ProcesoRunnable(recurso, 2)));
        procesos.add(new Thread(new ProcesoRunnable(recurso, 3)));
        procesos.add(new Thread(new ProcesoRunnable(recurso, 1)));
        procesos.add(new Thread(new ProcesoRunnable(recurso, 3)));
    ...
    public static class ProcesoRunnable implements Runnable {
        private RecursoCompartido recurso;
        private int prioridad;
        
        public ProcesoRunnable(RecursoCompartido recurso, int prioridad) {
