...
public class BarajaSpain extends Baraja {
	 
    private boolean incluye_8_9;
 
    public BarajaSpain(boolean incluye_8_9) {
        super();
    ...
    public void crearBaraja() {
        ...
        this.cartas = (Carta<PalosBarajaSpain>[]) new Carta[numCartas];
     
        PalosBarajaSpain[] palos = PalosBarajaSpain.values();
